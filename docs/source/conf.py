...
version = crimson_forge.__version__
...
htmlhelp_basename = 'CrimsonForgedoc'
...
latex_documents = [
    (master_doc, 'CrimsonForge.tex', 'Crimson Forge Documentation',
...
man_pages = [
    (master_doc, 'crimsonforge', 'Crimson Forge Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'CrimsonForge', 'Crimson Forge Documentation',
     author, 'CrimsonForge', 'One line description of project.',
     'Miscellaneous'),
]
