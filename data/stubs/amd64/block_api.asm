...
_blkapi_get_next_func:             ;
  jrcxz _blkapi_get_next_mod       ; When we reach the start of the EAT (we search backwards), process the next module
...
_blkapi_get_next_mod:              ;
  pop rax                          ; Pop off the current (now the previous) modules EAT
_blkapi_get_next_mod1:             ;
  pop r9                           ; Pop off the current (now the previous) modules hash
  pop rdx                          ; Restore our position in the module list
  mov rdx, [rdx]                   ; Get the next module
  jmp _blkapi_next_mod             ; Process this module
